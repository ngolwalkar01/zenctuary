 ...
 */
?>
<!-- wp:media-text {"align":"full","mediaPosition":"right","mediaType":"image","imageFill":true,"backgroundColor":"secondary-grey-dark"} -->
<div class="wp-block-media-text alignfull has-media-on-the-right is-stacked-on-mobile is-image-fill has-secondary-grey-dark-background-color has-background"><figure class="wp-block-media-text__media" style="background-image:url(https://s.w.org/images/core/2.0.1/water.jpg);background-position:50% 50%"><img src="https://s.w.org/images/core/2.0.1/water.jpg" alt=""/></figure><div class="wp-block-media-text__content">
    ...
    <div class="wp-block-group" style="padding-right:15%;padding-left:15%">
        ...
        <div class="wp-block-buttons">
            <!-- wp:button {"className":"zen-btn--small"} -->
            <div class="wp-block-button zen-btn--small"><a class="wp-block-button__link wp-element-button">General</a></div>
            <!-- /wp:button -->
